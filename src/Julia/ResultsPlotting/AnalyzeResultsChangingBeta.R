...
Folder="../ResultsFiles"
Nominal_Results = "ChangingBeta_delta0.00_gamma1.00_mu1.125.csv"
Robust_Results = "ChangingBeta_delta0.08_gamma0.04_mu1.1875.csv"
...
ggplot(df1,aes(x=beta))+
  ...
  #geom_vline(xintercept =df2[df2$method=="Nominal",]$min_beta,linetype="dotted",size=1)+
  ...
  #geom_vline(xintercept =df2[df2$method=="Robust",]$min_beta,linetype="dotted",size=1,color='darkgray')+
...
#ggsave("Patient4_Visit1_udbar_vs_beta_robut.png",height=4.2, width=5.8)
outputfile=sprintf("./%s/%s",Folder,"Patient4_Visit1_udbar_vs_beta_nominal_robust.png")
...
#ggsave("Patient4_Visit1_violation_sum_and_num_vs_beta_robust.png",height=4.2)
outputfile=sprintf("./%s/%s",Folder,"Patient4_Visit1_violation_sum_and_num_vs_beta_nominal_robust.png")
